...
import {readabilityScores, ReadabilityScoreResult} from './index.js'

test('readabilityScores', (t) => {
  let s: string
  let results: ReadabilityScoreResult
  ...
  if (results.daleChallDifficultWordCount === null) {
    t.fail()
  }

  if (results.polysyllabicWordCount === null) {
    t.fail()
  }
  ...
  function fleschKincaidDoesNotExist() {
    t.equals(results.fleschKincaid, undefined, 'Flesch-Kincaid does not exist.')
  }
